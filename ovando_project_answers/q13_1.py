...
#desired file
file_name = 'data_set_2.txt'

# importing the data from the file
x = np.loadtxt('/Users/apple/Documents/coding/companies/FDM/FDM_training/FDM_Python_2/Project/Project-1/' + file_name, dtype=str, delimiter=";")

#converting the data from the file into an array
arr = np.array(x)
