...
echo Python MOCK for: %USERNAME%                         >> python-%USERNAME%.txt
echo =================================================== >> python-%USERNAME%.txt
echo ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ >> python-%USERNAME%.txt

REM Run Q1 unit tests
echo ========================================
echo Running tests for mock question 1:
python q1-test.py
...
echo ========================================
echo Running tests for mock question 2:
python q2-test.py
...
echo ========================================
echo Running tests for mock question 3:
python q3-test.py
...
echo ========================================
echo Running tests for mock question 4:
python q4-test.py
