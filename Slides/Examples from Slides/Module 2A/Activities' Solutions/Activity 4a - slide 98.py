# slide 98 - Activity 4a
'''
Create a copy of the Activity 3 script created earlier and
rename it to Activity 4a.
Include a PROTECTED class attribute annual_interest_rate to
the BankAccount class and set it to 0.001 (0.1%). Ensure it
can only be changed by the method set_annual_interest_rate().

Test the class constant annual_interest_rate to ensure that
it cannot be changed directly from an object, and that can
be changed using the set_annual_interest_rate() method.
'''
class BankAccount():
    # class attributes
    no_accounts = 0
    _annual_interest_rate = 0.001
    ...
    def annual_interest_rate(self):
        return self.__class__._annual_interest_rate
    ...
    def set_annual_interest_rate(cls, new_annual_interest_rate):
        cls._annual_interest_rate = new_annual_interest_rate
