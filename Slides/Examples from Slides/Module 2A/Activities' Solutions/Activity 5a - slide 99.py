# slide 99 - Activity 5a
'''
Create a copy of the Activity 4a script created earlier and
rename it to Activity 5a.
Include a class attribute annual_interest_rate to the
BankAccount class and set it to 0.001 (0.1%).
...
class BankAccount():
    ...
    def calc_interest(self, num_years):
        ...
        ann_int_rate = self.__class__._annual_interest_rate
